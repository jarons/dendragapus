...
/****************************************************************/
#ifndef INTERRUPTIBLETRANSIENTMULTIAPP_H
#define INTERRUPTIBLETRANSIENTMULTIAPP_H
...
public:
  ...
  /// Jaron was here: return flag for re-solved condition
  bool is_re_solved();
...
private:
  ...
  /// Jaron was here: flag for re-solved condition
  bool _re_solved;
};

#endif // INTERRUPTIBLETRANSIENTMULTIAPP_H
