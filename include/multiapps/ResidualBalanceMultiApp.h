...
/****************************************************************/
#ifndef RESIDUALBALANCEMULTIAPP_H
#define RESIDUALBALANCEMULTIAPP_H
...
// You are a bad person, you should inherit from TransientMultiApp instead

class ResidualBalanceMultiApp;
...
{
public:
  ResidualBalanceMultiApp(const std::string & name, InputParameters parameters);

  virtual ~ResidualBalanceMultiApp();
  ...
  virtual void initialSetup();  //used to be init()
...
#endif // RESIDUALBALANCEMULTIAPP_H
