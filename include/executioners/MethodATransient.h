...
#ifndef METHODATRANSIENT_H
#define METHODATRANSIENT_H
 ...
 * for each timestep.
 */
class MethodATransient: public Transient //Executioner
{
public:
  /**
   * Constructor
   ...
   */
  MethodATransient(const std::string & name, InputParameters parameters);
  virtual ~MethodATransient();
...
/*
  ...
  //bool & _first; //This gave us an error, can we just comment it out?
 ...
 */
  ///Multiapp stuff
  // TransientMultiAppF & multiapp 
};

#endif //METHODATRANSIENT_H
